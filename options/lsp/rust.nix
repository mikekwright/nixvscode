...
{
  vscodeExtensions = with extra-pkgs.extensions; options.extensions "lsp.rust" [
  ...
  packages = with pkgs; options.packages "lsp.rust" [
  ...
  aiGenerationInstructions = options.ai "lsp.rust" (funcs.buildLangAiInstructions "rust" [
  ...
  aiTestInstructions = options.ai "lsp.rust" (funcs.buildLangAiInstructions "rust" [
