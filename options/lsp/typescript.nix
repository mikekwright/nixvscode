...
{
  vscodeExtensions = with extra-pkgs.extensions; options.extensions "lsp.typescript" [
  ...
  packages = with pkgs; options.packages "lsp.typescript" [
    eslint_d
  ...
  vscodeSettings = {
    ...
    options.packages "lsp.typescript"
    {
